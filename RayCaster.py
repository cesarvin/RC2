...
textures = {
    '1' : pygame.image.load('./Texturas/colorstone.png'),
    '2' : pygame.image.load('./Texturas/bluestone.png'),
    '3' : pygame.image.load('./Texturas/eagle.png'),
    '4' : pygame.image.load('./Texturas/mossy.png'),
    '5' : pygame.image.load('./Texturas/purplestone.png'),
    '6' : pygame.image.load('./Texturas/redbrick.png'),
    '7' : pygame.image.load('./Texturas/wood.png')
    }
